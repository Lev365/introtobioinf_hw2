...
(2) The paper is actually a sub-study of a study which investigate the effect of dietry supplaments on the immune response after a             fat-rich meal.
    ...
    There are 5 subjects, each given 3 meals on different days, each with different dietry supplaments which had an insegnificant effect       Thus overall 3x5x3=45 transcriptomes where performed.
